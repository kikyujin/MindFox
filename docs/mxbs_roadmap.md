...
| タイトル | 内容 | MxBS 利用 |
|---|---|---|
| **Indian Poker** | AI娘とカードゲーム | MxBS + MxMindFox（最初のクライアント） |
| **PoW-WWI** | 第一次大戦前ヨーロッパ地政学シミュレーション | MxBS + MxMindFox + Unity (C# P/Invoke) |

- [ ] Indian Poker MxBS + MxMindFox 対応
- [ ] PoW-WWI 設計更新（MxBS / MxMindFox / JUWA 統合軸）
